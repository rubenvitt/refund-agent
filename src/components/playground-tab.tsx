...
function CollapsibleJson({
  ...
  return (
    <details open={defaultOpen} className="group rounded border bg-muted/50">
      <summary className="flex cursor-pointer list-none items-center gap-1.5 px-2 py-1 text-xs font-medium text-muted-foreground hover:text-foreground">
        <ChevronRight className="size-3 transition-transform group-open:rotate-90" />
        {label}
      </summary>
      <pre className="border-t px-2 py-1.5 font-mono text-xs break-all whitespace-pre-wrap">
        {json}
      </pre>
    </details>
  );
